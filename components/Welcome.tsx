...
const WelcomeCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
  <div className="bg-surface-light p-6 rounded-lg shadow-card hover:shadow-xl transition-shadow duration-300 text-left border border-border-light">
...
const Welcome: React.FC<WelcomeProps> = ({ laws }) => {
  return (
    <div className="animate-fade-in text-center max-w-6xl mx-auto">
      <h1 className="text-6xl font-bold font-display text-text-primary leading-tight">Navigate Breach Laws with Confidence</h1>
